...
Please review these [Onboarding Guidelines](https://docs.google.com/document/d/12mKm5L2QYG5KNq3BLzqmOghY_q5v30HjlCyDKJd1-k8/edit?usp=sharing) so you know you are on the right track. Work with your NOAA Fisheries representatives, IT team, and others involved with the onboarding process to ask questions, clarify the process, and provide updates as steps are completed.
...
This AA-SI GitHub site is public, but to access and work in the [repositories](https://github.com/orgs/nmfs-ost/repositories?q=AA) (e.g., view, push/pull) a person needs to have a NOAA GitHub Enterprise License. To start, follow this [link](https://github.com/enterprises/noaa-nmfs) to fill out the request form, learn more about NOAA GitHub Enterprise Licenses, and find out Science Center-specific procedures.
